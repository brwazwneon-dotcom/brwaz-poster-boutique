...
function parseFlags(raw: unknown): PerformanceFlags {
  ...
  if (raw && typeof raw === "object") {
    ...
    if (typeof v.disable_social_proof === "boolean") base.disable_social_proof = v.disable_social_proof;
    if (typeof v.disable_floating_offer === "boolean") base.disable_floating_offer = v.disable_floating_offer;
