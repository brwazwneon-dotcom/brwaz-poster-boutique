...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-[calc(1.25rem+var(--mobile-bar-h,0px))] right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition hover:scale-105 hover:shadow-[0_12px_28px_rgba(37,211,102,0.45)] sm:bottom-8 sm:right-8 sm:h-16 sm:w-16"
    >
