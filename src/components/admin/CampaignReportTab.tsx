  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-sm border border-border bg-muted/30 p-4 text-xs text-muted-foreground">
        ...
        <code className="mx-1">audience_type</code>, <code>landing_page</code>, and{" "}
        <code>utm_campaign</code>. Use Meta Events Manager to build custom audiences per campaign.
      </div>
    </div>
  );
}
